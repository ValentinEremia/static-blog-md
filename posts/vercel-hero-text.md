...
You can see the source code of [this site Hero](https://github.com/ValentinEremia/static-blog-md/blob/main/components/VercelHeroText.tsx) to see how I implemented it. Hope you enjoyed the read.